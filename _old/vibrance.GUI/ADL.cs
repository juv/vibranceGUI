...
namespace ATI.ADL
{
    ...
    internal delegate int ADL_Display_Color_Set(int a, int b, int c, int d);

    internal delegate int ADL_Display_Color_Get(int a, int b, int c, ref int d, ref int e, ref int f, ref int g, ref int h);
    ...
    internal static class ADL
    {
        ...
        private static class ADLImport
        {
            ...
            [DllImport(Atiadlxx_FileName)]
            internal static extern int ADL_Display_Color_Set(int a, int b, int c, int d);

            [DllImport(Atiadlxx_FileName)]
            internal static extern int ADL_Display_Color_Get(int a, int b, int c, ref int d, ref int e, ref int f, ref int g, ref int h);
        ...
        #region ADL_Display_Color_Set
        /// <summary> ADL_Display_Color_Set Delegates</summary>
        internal static ADL_Display_Color_Set ADL_Display_Color_Set
        {
            get
            {
        ...
        internal static ADL_Display_Color_Get ADL_Display_Color_Get
        {
            get
            {
        ...
        /// <summary> Private Delegate</summary>
        private static ADL_Display_Color_Set ADL_Display_Color_Set_ = null;
        private static ADL_Display_Color_Get ADL_Display_Color_Get_ = null;
        /// <summary> check flag to indicate the delegate has been checked</summary>
        private static bool ADL_Display_Color_Set_Check = false;
        private static bool ADL_Display_Color_Get_Check = false;
        #endregion ADL_Display_Color_Set
